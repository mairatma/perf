...
Templates.List.__deltemplate_s13_88b68f86 = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('ComponentElement'), 'List', true)(soy.$$augmentMap(opt_data, {elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ((opt_ijData.renderChildComponents) ? Templates.List.content(opt_data, null, opt_ijData) : ''))}), null, opt_ijData));
};
if (goog.DEBUG) {
 ...
 * @suppress {checkTypes}
 */
Templates.List.__deltemplate_s27_bba2b725 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.List.__deltemplate_s27_bba2b725.soyTemplateName = 'Templates.List.__deltemplate_s27_bba2b725';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ComponentElement'), 'List', 0, Templates.List.__deltemplate_s27_bba2b725);
 ...
 * @suppress {checkTypes}
 */
Templates.List.__deltemplate_s29_cb520c3e = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.List.__deltemplate_s29_cb520c3e.soyTemplateName = 'Templates.List.__deltemplate_s29_cb520c3e';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('List.rows'), 'element', 0, Templates.List.__deltemplate_s29_cb520c3e);
 ...
 * @suppress {checkTypes}
 */
Templates.List.__deltemplate_s35_24a7c50c = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('List.rows'), 'element', true)(soy.$$augmentMap(opt_data, {elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ((opt_ijData.renderChildComponents) ? Templates.List.rows(opt_data, null, opt_ijData) : ''))}), null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.List.__deltemplate_s35_24a7c50c.soyTemplateName = 'Templates.List.__deltemplate_s35_24a7c50c';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('List.rows'), '', 0, Templates.List.__deltemplate_s35_24a7c50c);
