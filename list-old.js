...
(function () {
     ...
     * @suppress {checkTypes}
     */
    bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.component = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.component.soyTemplateName = "Templates.SoyComponent.component";
    }
     ...
     * @suppress {checkTypes}
     */
    bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.surface = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(opt_data.content));
    };
    if (goog.DEBUG) {
        bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.surface.soyTemplateName = "Templates.SoyComponent.surface";
    }
     ...
     * @suppress {checkTypes}
     */
    bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.__deltemplate_s6_26860e4b = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.__deltemplate_s6_26860e4b.soyTemplateName = "Templates.SoyComponent.__deltemplate_s6_26860e4b";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentChildren"), "", 0, bower_components$metaljs$src$soy$SoyComponent$soy$$Templates.SoyComponent.__deltemplate_s6_26860e4b);
     ...
     */
    var bower_components$metaljs$src$soy$SoyComponent$$originalTemplate = bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.component;
    var bower_components$metaljs$src$soy$SoyComponent$$originalSurfaceTemplate = bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.surface;
        ...
        _createClass(bower_components$metaljs$src$soy$SoyComponent$$SoyComponent, {
            ...
            handleSurfaceCall_: {
                ...
                value: function handleSurfaceCall_(data, ignored, ijData) {
                    var rendered = bower_components$metaljs$src$soy$SoyComponent$$originalSurfaceTemplate(data, ignored, ijData);
            ...
            handleTemplateCall_: {
                ...
                value: function handleTemplateCall_(data, ignored, ijData) {
                    ...
                    var component = bower_components$metaljs$src$soy$SoyComponent$$SoyComponent.componentsCollector.createOrUpdateComponent(data.componentName, config);
                    ...
                    var renderedComponent = bower_components$metaljs$src$soy$SoyComponent$$originalTemplate(newData, ignored, ijData);
            ...
            renderTemplate_: {
                ...
                value: function renderTemplate_(templateFn, opt_injectedData) {
                    bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.component = this.handleTemplateCall_.bind(this);
                    bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.surface = this.handleSurfaceCall_.bind(this);
                    var content = templateFn(this, null, opt_injectedData || {}).content;
                    bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.component = bower_components$metaljs$src$soy$SoyComponent$$originalTemplate;
                    bower_components$metaljs$src$component$ComponentRegistry$$default.Templates.SoyComponent.surface = bower_components$metaljs$src$soy$SoyComponent$$originalSurfaceTemplate;
                    return content;
                }
            },
    ...
    metaljs$src$list$soy$$Templates.List.__deltemplate_s10_88d36183 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$list$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "List" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$list$soy$$Templates.List.__deltemplate_s13_88b68f86 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("List"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$list$soy$$Templates.List.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$list$soy$$Templates.List.__deltemplate_s13_88b68f86.soyTemplateName = "Templates.List.__deltemplate_s13_88b68f86";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "List", 0, metaljs$src$list$soy$$Templates.List.__deltemplate_s13_88b68f86);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$list$soy$$Templates.List.__deltemplate_s19_4ac84340 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$list$soy$$Templates.List.__deltemplate_s19_4ac84340.soyTemplateName = "Templates.List.__deltemplate_s19_4ac84340";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("List"), "element", 0, metaljs$src$list$soy$$Templates.List.__deltemplate_s19_4ac84340);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$list$soy$$Templates.List.__deltemplate_s27_cb520c3e = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$list$soy$$Templates.List.__deltemplate_s27_cb520c3e.soyTemplateName = "Templates.List.__deltemplate_s27_cb520c3e";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("List.rows"), "element", 0, metaljs$src$list$soy$$Templates.List.__deltemplate_s27_cb520c3e);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$list$soy$$Templates.List.__deltemplate_s33_24a7c50c = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("List.rows"), "element", true)({ elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + (!opt_ijData.skipSurfaceContents ? soy.$$escapeHtml(metaljs$src$list$soy$$Templates.SoyComponent.surface({ content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$list$soy$$Templates.List.rows(opt_data, null, opt_ijData)), id: opt_data.id + "-rows" }, null, opt_ijData)) : "")), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$list$soy$$Templates.List.__deltemplate_s33_24a7c50c.soyTemplateName = "Templates.List.__deltemplate_s33_24a7c50c";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("List.rows"), "", 0, metaljs$src$list$soy$$Templates.List.__deltemplate_s33_24a7c50c);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s160_53d5ac21 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$nested$nestedList$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "NestedList" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s160_53d5ac21.soyTemplateName = "Templates.NestedList.__deltemplate_s160_53d5ac21";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedList"), "", 0, metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s160_53d5ac21);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s163_7b42aa33 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("NestedList"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$nested$nestedList$soy$$Templates.NestedList.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s163_7b42aa33.soyTemplateName = "Templates.NestedList.__deltemplate_s163_7b42aa33";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "NestedList", 0, metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s163_7b42aa33);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s169_473fc56f = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s169_473fc56f.soyTemplateName = "Templates.NestedList.__deltemplate_s169_473fc56f";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedList"), "element", 0, metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s169_473fc56f);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s177_71fca2ab = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml("<div id=\"" + soy.$$escapeHtmlAttribute(opt_data.id) + "-rows\">" + soy.$$escapeHtml(opt_data.elementContent) + "</div>");
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s177_71fca2ab.soyTemplateName = "Templates.NestedList.__deltemplate_s177_71fca2ab";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedList.rows"), "element", 0, metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s177_71fca2ab);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s183_f2f6b9c5 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("NestedList.rows"), "element", true)({ elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + (!opt_ijData.skipSurfaceContents ? soy.$$escapeHtml(metaljs$src$nested$nestedList$soy$$Templates.SoyComponent.surface({ content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$nested$nestedList$soy$$Templates.NestedList.rows(opt_data, null, opt_ijData)), id: opt_data.id + "-rows" }, null, opt_ijData)) : "")), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s183_f2f6b9c5.soyTemplateName = "Templates.NestedList.__deltemplate_s183_f2f6b9c5";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedList.rows"), "", 0, metaljs$src$nested$nestedList$soy$$Templates.NestedList.__deltemplate_s183_f2f6b9c5);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s58_0f8b7ac8 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "DeeplyNestedList" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s58_0f8b7ac8.soyTemplateName = "Templates.DeeplyNestedList.__deltemplate_s58_0f8b7ac8";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList"), "", 0, metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s58_0f8b7ac8);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s61_8c1e7708 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s61_8c1e7708.soyTemplateName = "Templates.DeeplyNestedList.__deltemplate_s61_8c1e7708";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "DeeplyNestedList", 0, metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s61_8c1e7708);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s67_18eefb75 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s67_18eefb75.soyTemplateName = "Templates.DeeplyNestedList.__deltemplate_s67_18eefb75";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList"), "element", 0, metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s67_18eefb75);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s75_265b09b2 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml("<div id=\"" + soy.$$escapeHtmlAttribute(opt_data.id) + "-rows\">" + soy.$$escapeHtml(opt_data.elementContent) + "</div>");
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s75_265b09b2.soyTemplateName = "Templates.DeeplyNestedList.__deltemplate_s75_265b09b2";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList.rows"), "element", 0, metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s75_265b09b2);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s81_a7a9269d = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList.rows"), "element", true)({ elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + (!opt_ijData.skipSurfaceContents ? soy.$$escapeHtml(metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.SoyComponent.surface({ content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.rows(opt_data, null, opt_ijData)), id: opt_data.id + "-rows" }, null, opt_ijData)) : "")), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s81_a7a9269d.soyTemplateName = "Templates.DeeplyNestedList.__deltemplate_s81_a7a9269d";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedList.rows"), "", 0, metaljs$src$deeply_nested$deeplyNestedList$soy$$Templates.DeeplyNestedList.__deltemplate_s81_a7a9269d);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s96_97c5d38d = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "DeeplyNestedListItem" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s96_97c5d38d.soyTemplateName = "Templates.DeeplyNestedListItem.__deltemplate_s96_97c5d38d";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItem"), "", 0, metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s96_97c5d38d);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s99_397653ff = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItem"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s99_397653ff.soyTemplateName = "Templates.DeeplyNestedListItem.__deltemplate_s99_397653ff";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "DeeplyNestedListItem", 0, metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s99_397653ff);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s105_011b2482 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s105_011b2482.soyTemplateName = "Templates.DeeplyNestedListItem.__deltemplate_s105_011b2482";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItem"), "element", 0, metaljs$src$deeply_nested$deeplyNestedListItem$soy$$Templates.DeeplyNestedListItem.__deltemplate_s105_011b2482);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s118_5ea078b6 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s118_5ea078b6.soyTemplateName = "Templates.DeeplyNestedListItemContent.__deltemplate_s118_5ea078b6";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent"), "element", 0, metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s118_5ea078b6);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s126_09caa2a1 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s126_09caa2a1.soyTemplateName = "Templates.DeeplyNestedListItemContent.__deltemplate_s126_09caa2a1";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent.text"), "element", 0, metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s126_09caa2a1);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s132_597ae112 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "DeeplyNestedListItemContent" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s132_597ae112.soyTemplateName = "Templates.DeeplyNestedListItemContent.__deltemplate_s132_597ae112";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent"), "", 0, metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s132_597ae112);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s135_49d81640 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s135_49d81640.soyTemplateName = "Templates.DeeplyNestedListItemContent.__deltemplate_s135_49d81640";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "DeeplyNestedListItemContent", 0, metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s135_49d81640);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s141_99f5bb76 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent.text"), "element", true)({ elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + (!opt_ijData.skipSurfaceContents ? soy.$$escapeHtml(metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.SoyComponent.surface({ content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.text(opt_data, null, opt_ijData)), id: opt_data.id + "-text" }, null, opt_ijData)) : "")), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s141_99f5bb76.soyTemplateName = "Templates.DeeplyNestedListItemContent.__deltemplate_s141_99f5bb76";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("DeeplyNestedListItemContent.text"), "", 0, metaljs$src$deeply_nested$deeplyNestedListItemContent$soy$$Templates.DeeplyNestedListItemContent.__deltemplate_s141_99f5bb76);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s200_c07ea9a1 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(metaljs$src$nested$nestedListItem$soy$$Templates.SoyComponent.component(soy.$$augmentMap(opt_data, { componentName: "NestedListItem" }), null, opt_ijData)));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s200_c07ea9a1.soyTemplateName = "Templates.NestedListItem.__deltemplate_s200_c07ea9a1";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedListItem"), "", 0, metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s200_c07ea9a1);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s203_d393a52c = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("NestedListItem"), "element", true)({ elementClasses: opt_data.elementClasses, elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.content(opt_data, null, opt_ijData)), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s203_d393a52c.soyTemplateName = "Templates.NestedListItem.__deltemplate_s203_d393a52c";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("ComponentTemplate"), "NestedListItem", 0, metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s203_d393a52c);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s209_01d1e9dd = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s209_01d1e9dd.soyTemplateName = "Templates.NestedListItem.__deltemplate_s209_01d1e9dd";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedListItem"), "element", 0, metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s209_01d1e9dd);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s217_ac1d7149 = function (opt_data, opt_ignored, opt_ijData) {
    ...
    if (goog.DEBUG) {
        metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s217_ac1d7149.soyTemplateName = "Templates.NestedListItem.__deltemplate_s217_ac1d7149";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedListItem.label"), "element", 0, metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s217_ac1d7149);
     ...
     * @suppress {checkTypes}
     */
    metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s223_ac2cc419 = function (opt_data, opt_ignored, opt_ijData) {
        return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId("NestedListItem.label"), "element", true)({ elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + (!opt_ijData.skipSurfaceContents ? soy.$$escapeHtml(metaljs$src$nested$nestedListItem$soy$$Templates.SoyComponent.surface({ content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks("" + metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.label(opt_data, null, opt_ijData)), id: opt_data.id + "-label" }, null, opt_ijData)) : "")), id: opt_data.id }, null, opt_ijData));
    };
    if (goog.DEBUG) {
        metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s223_ac2cc419.soyTemplateName = "Templates.NestedListItem.__deltemplate_s223_ac2cc419";
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId("NestedListItem.label"), "", 0, metaljs$src$nested$nestedListItem$soy$$Templates.NestedListItem.__deltemplate_s223_ac2cc419);
